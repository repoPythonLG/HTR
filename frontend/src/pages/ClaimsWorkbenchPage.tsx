...
export function ClaimsWorkbenchPage() {
  ...
  return (
    <div className="app-page receipts-workbench-page">
      <CollapsiblePanel className="panel" title="Queue Summary" collapsible={false}>
        <div className="section-title-row">
          <h2 className="section-title"><ReceiptsIcon size={18} />Travel Expense Queue</h2>
      ...
      <CollapsiblePanel className="panel receipts-workbench-panel app-grow" title="Travel Expense Entries" allowFocusView>
